...
<div id="container">
    ...
    <header id="header">
        ...
        <div class="username btn-group pull-right">
            <a href="javascript:void(0);" class="user-btn dropdown-toggle" data-toggle="dropdown">
                <i class="glyphicon glyphicon-user"></i> <?php echo $username;?><span class="caret"></span>
            </a>
    ...
    <!-- Main -->
    <div id="main">
        <iframe id="main-frame" name="main-frame" frameborder="0" src="<?php echo site_url('c=admin&m=welcome');?>"></iframe>
    </div>
    <!-- Main End -->
        ...
        menu: [
            {
                text: "便捷,只为你而变!",
                items: [],
                href: "<?php echo site_url('c=admin&m=welcome');?>"
            }
        ]
    },
    {
